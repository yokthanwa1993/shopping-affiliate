...
- ใช้ metadata แยกของ Studio เดิมแบบ read-only: `ai_caption_text` เป็นชื่อสินค้า และเลือกข้อความจาก `ai_hashtags_json` ที่ไม่ซ้ำกับชื่อมาเป็นจุดขายสำคัญ 2 อย่างแบบ deterministic; เริ่มจาก 3 แฮชแท็กแรก และย่อแฮชแท็กเฉพาะเมื่อจำเป็นเพื่อให้ข้อความรวมไม่เกิน 130 ตัวอักษร
- ถ้าหาจุดขายที่แตกต่างจากชื่อสินค้าไม่ครบ 2 อย่าง หรือประกอบแล้วเกินเพดาน ให้หยุดก่อนเรียก Facebook `/post`; ไม่เขียนผลกลับ Studio SQLite และไม่เปลี่ยนโพสต์เก่า
